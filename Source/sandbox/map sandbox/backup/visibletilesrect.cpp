...
//----[  center  ]-----------------------------------------------------------
void VisibleTilesRect::center(int x,
                              int y,
                              int half_width,
                              int half_height) {
  left_ = x - half_width;
...
//----[  moveTo  ]-----------------------------------------------------------
void VisibleTilesRect::moveTo(int x,
                              int y,
                              int half_width,
                              int half_height,
                              Area* r1,
                              Area* r2) {
  VisibleTilesRect old(*this);
...
//----[  newTilesIn  ]-------------------------------------------------------
void VisibleTilesRect::newTilesIn(const VisibleTilesRect* other,
                                  Area* r1,
                                  Area* r2) {
...
//----[  subcoordinate  ]------------------------------------------------------
bool VisibleTilesRect::subcoordinate(int x, int y, int* sub_x, int* sub_y) {
