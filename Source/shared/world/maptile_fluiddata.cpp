...
//----[  MapTile_FluidData_Sorter  ]-------------------------------------------
int MapTile_FluidData_Sorter(const void* p1, const void* p2) {
  using namespace Evidyon::World;
  const MapTile_FluidData* a = (const MapTile_FluidData*)p1;
  const MapTile_Data* a_data = a->data;
  const MapTile_FluidData* b = (const MapTile_FluidData*)p2;
  ...
  Evidyon::Texture::TextureIndex a_texture = a_data->visual_data.fluid_texture;
  Evidyon::Texture::TextureIndex b_texture = b_data->visual_data.fluid_texture;
...
const MapTile_Data::SorterType MapTile_FluidData::Sorter
  = MapTile_FluidData_Sorter;
