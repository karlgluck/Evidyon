...
//---------------------------------------------------------------------------//
#ifndef __EVIDYONGUIMOUSEINPUTSOURCE_H__
#define __EVIDYONGUIMOUSEINPUTSOURCE_H__
#pragma once
 ...
 */
class EvidyonGUIMouseInputSource : public GUIMouseInputSource
{
public:

  EvidyonGUIMouseInputSource();
